...
DFP_ORDER_NAME = "Prebid [[ORDER_NAME]] [[ADUNIT_NAME]] [[WIDTH]]x[[HEIGHT]]"
...
DFP_ADVERTISER_NAME = "[[ADVERTISER_NAME]]"
...
DFP_TARGETED_AD_UNIT_NAMES = ["[[ADUNIT_NAME]]"]

# Sizes of placements. These are used to set line item and creative sizes.
DFP_PLACEMENT_SIZES = [{'width':[[WIDTH]], 'height':[[HEIGHT]]}]
